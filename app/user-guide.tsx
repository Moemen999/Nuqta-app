...
const SECTIONS: Section[] = [
  {
    ...
    body: [
      ...
      'كل فئة ليها أيقونة: اختار من القايمة، أو "أيقونة من الكيبورد" واكتب أي إيموجي. لو الأيقونة مستخدمة في فئة تانية هنقولك ونقترح غيرها، بس القرار ليك.',
    ],
  },
  {
    id: 'reports',
  ...
  },
  {
    ...
    title: 'الدخل الثابت',
    body: [
      'من التخطيط ← دخل ثابت: ضيف مرتبك أو أي فلوس بتنزلك بمعاد — كل شهر في يوم معيّن، أو كل أسبوع في يوم معيّن. لو اليوم 31 والشهر أقصر، بياخد آخر يوم.',
      '"بيسألك الأول" (المقترح): يوم المعاد بيجيلك إشعار وكارت في الرئيسية "نزل؟". تقدر تقول نزل، أو تكتب المبلغ لو مختلف، أو "ما نزلش".',
      '"بيتسجل لوحده": أول ما تفتح التطبيق بعد المعاد بيتسجل، وبيجيلك إشعار إنه اتسجل. لو فاتك كذا شهر بتتسجل كلها مرة واحدة برسالة واحدة. التسجيل محتاج نت، ولو مفيش بيستنى لحد ما يرجع.',
      'عمره ما بيتسجل مرتين لنفس الشهر — حتى لو فتحت التطبيق من موبايلين، أو مسحت العملية بإيدك.',
      'نزل بدري؟ دوس "نزل" من صفحة الدخل الثابت، والشهر ده بيتقفل. ولو شهر نزل مختلف، عدّل العملية نفسها — المبلغ المعتاد مبيتغيّرش.',
      'الإيقاف المؤقت: مش هيتسجل ولا هيسألك، ولما ترجّعه بيبدأ من يومها (الشهور اللي فاتت وهو واقف مش بتتسجل). "وقّفه" بيوقفه خالص، واللي اتسجل قبل كده بيفضل.',
      'لو لسه ما اتسجلش منه ولا مرة، تقدر تمسحه خالص ("امسحه"). بعد أول تسجيل مفيش مسح — وقّفه بس، عشان تاريخه يفضل.',
    ],
  },
  {
    id: 'debts',
    ...
    body: [
      ...
      'سجّلت دفعة أو زيادة غلط؟ افتح الدين ودوس على علامة المسح 🗑 جنبها. قبل ما تمسح هيقولك المبلغ، وعدد الأقساط لو هيتغيّر، والفلوس هترجع للمحفظة ولا هتتشال منها. المسح محتاج نت.',
  ...
  },
  {
    ...
    body: [
      ...
      'التذكير: بتحدد بنفسك تتنبّه قبل الموعد بكام يوم. بيوصلك إشعار من الموبايل (لو فعّلت الإشعارات من الإعدادات) وبيظهر بانر في الرئيسية كمان.',
  ...
  },
  {
    ...
    body: [
      ...
      'ولو نسيت الكود: في شاشة القفل فيه "نسيت الكود؟" — هيشيل القفل ويخرّجك من حسابك، وترجع تدخل بنفس الطريقة اللي سجّلت بيها (جوجل أو إيميل وباسورد) وبياناتك زي ما هي. محتاج نت عشان ترجع تدخل.',
      'علامة العين 👁 جنب الرصيد في الرئيسية بتخبّي كل المبالغ في التطبيق كله. لو عايز تشوف رقم واحد، دوس عليه ويبان ٣ ثواني.',
      'الإخفاء على الموبايل ده بس — لو فتحت حسابك على موبايل تاني هتختار هناك من الأول.',
      'وانت مخبّي المبالغ: الإشعارات بتوصل من غير أرقام، والخانة اللي بتكتب فيها مبلغ بتبان عادي، ورسالة التأكيد قبل أي دفع أو مسح بتقول الرقم الحقيقي عشان تعرف بتأكّد على إيه. وملف الإكسيل بيطلع بالأرقام الحقيقية.',
