/**
 * فاحص باليتة الرسوم — منقول كما هو من سكيل dataviz بتاع Claude.
 *
 * منقول جوه الريبو عن قصد: الفحوصات دي لازم تفضل شغالة مع كل تشغيل
 * للاختبارات، مش مرة واحدة وإحنا بنكتب الألوان. لو حد غيّر لون في
 * chartPalette واللون وقع في أي فحص، الاختبارات هتقع.
 *
 * متعدّلش الملف ده بالإيد — لو محتاج تحديث، انقله تاني من السكيل.
 */
