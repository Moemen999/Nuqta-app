 ...
 * مش لكل شاشة لوحدها. لو كل شاشة نادت `hashColor` على القائمة اللي هي
 * شايفاها بس (مفلترة أو لأ)، فئتين ممكن ياخدوا نفس اللون في شاشة وألوان
 * مختلفة في شاشة تانية — أو حتى في نفس الشاشة بين فترتي تقرير مختلفتين، لأن
 * `assignChartColors` بتحل التصادم حسب مين محتاج خانة الأول. المصدر الموحّد
 * هنا يضمن نفس اللون لنفس الفئة/المحفظة في كل مكان.
 */
